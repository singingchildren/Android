 ...
 * @author fanjiangpeng
 */
public class Act_Change_Nickname extends BaseActivity<PersonalDocumentPresenter> implements PersonalDocumentContract.View {
            ...
            case R.id.commit:
                if (PwdCheckUtil.selectViewData(etName)) {
                    ...
                    if (myApplication.globalData.isNutritionist()){
                        mPresenter.changeDocunment(nickname,"","","","","");
                    }else{
                        mPresenter.changeProfile(nickname,"","","","","","","");
                    }
