...
public class MentalityAdapter extends RecyclerView.Adapter<MentalityAdapter.ViewHolder> {

    private Context context;
    private List<MyHealthGuidePlan2Bean.DataBean.PlanListBean> list  = new ArrayList<>();

    public MentalityAdapter(Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.mentalityitem,null));
    }
