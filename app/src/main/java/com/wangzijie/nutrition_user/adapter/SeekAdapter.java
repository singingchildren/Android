...
public class SeekAdapter extends BaseQuickAdapter<SiteData, BaseViewHolder> {
    private Context mcontext;

    public SeekAdapter(int layoutResId, @Nullable List<SiteData> data, Context mcontext) {
