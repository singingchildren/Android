...
public  class Constant {
    ...
    public static final int SITE_REQUEST_CODE = 300;//跳转到定位

    public static final int REQUEST_CODE_FOOD = 301;//提交完睡眠跳回
    public static final int REQUEST_CODE_SLEEP = 302;//提交完睡眠跳回
    public static final int REQUEST_CODE_SPORT= 303;//提交完运动跳回
    public static final int REQUEST_CODE_PSYCHOLOGY= 304;//提交完运动跳回

    public static final int REQUEST_CODE_PAY= 888;//启动支付页面
    public static final int RESULT_CODE_PAY= 666;//支付成功跳回


    public static final int IMAGE_UPLOAD_LIMIT=4;//图片上传的上限
    public static final int CHART_MOVE_DIFFERENCE_VALUE=5;//折线图X轴移动时偏移的坐标的


    public static final int LIMIT = 10;//每次请求的条数
    public static final int UNVERIFIED_ROLE = 0;  //营养师身份
    public static final int USER_ROLE = 1;  //营养师身份
    public static final int NUTRITIONIST_ROLE = 2;  //用户身份



    public static final int CERTIFIED=1;//已认证
    public static final String DIETICIAN="dietician";//营养师
    public static final String CUSTOMER="customer";//会员
    public static final long HTTP_CONNECT_TIMEOUT = 3;
    public static final long HTTP_READ_TIMEOUT = 3;
    public static final long HTTP_WRITE_TIMEOUT = 3;


    public static final String PAY_SUCCESS="PAY_SUCCESS";//支付成功状态
    public static final String PAY_FAILED="PAY_FAILED";//支付失败状态
