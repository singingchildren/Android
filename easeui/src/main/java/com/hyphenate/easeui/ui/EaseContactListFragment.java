...
import com.hyphenate.easeui.adapter.ActivityApplicationFriend;
...
//                startActivity(intent);
        ...
        friend = getView().findViewById(R.id.friend);
        friend.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), ActivityApplicationFriend.class);
                startActivity(intent);
            }
        });
        //search
